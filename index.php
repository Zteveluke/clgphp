...
<body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-warning">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      ...
                      <li><a class="dropdown-item" href="C://xampp/htdocs/clg/gallery.php">Photo Gallery</a></li>
                    </ul>
                  </li>
                  <li class="nav-item">
          ...
          <nav class="navbar navbar-light bg-light">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col col-12 col-sm-2 col-lg-2 col-md-2 col-xl-2 col-xxl-2">
                            <img height="10px" src="2535_logo.jpg" class="img-thumbnail" alt="...">
                        </div>
            ...
            <br><strong>Mission: </strong>To facilitate comprehensive and integrated development of individuals imbued with righteousness and courage of conviction, to effectively function as social beings. the main mission of the rajagiri is to make the student more professionsally skilled and make each student as a good human beaing
                        </div>
                    </div>
                </div>
              </span>
    ...
    <div class="container">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img height="700px" src="Screenshot 2021-03-14 095406.jpg" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img height="700px" src="Screenshot 2021-03-14 100422.jpg " class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img height="700px" src="Screenshot 2021-03-14 100626.jpg" class="d-block w-100" alt="...">
                  </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col col-12 col-sm-6 col-lg-6 col-md-6 col-xl-6 col-xxl-6">
                ...
                <center><img height="30px" src="2535_logo.jpg" class="img-fluid" alt="..."></center>
                <p></p>
